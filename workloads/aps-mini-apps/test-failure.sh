...
bash $active_dir/$failure_script $mean_failure_interval $mean_recover_interval $active_dir $NODE_FILE > $log_dir/failure-injector.out 2> $log_dir/failure-injector.err &
injector_pid=$!
