...
def main():
    ...
    cfg.set_integer("execution.checkpointing.timeout", 200000)  # 1 minutes
    cfg.set_integer("execution.checkpointing.min-pause", 200000)  # 5 seconds between checkpoints
